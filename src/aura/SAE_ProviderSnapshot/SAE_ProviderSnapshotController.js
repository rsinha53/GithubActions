({
    ...
    handleTopicClick: function (component, event, helper) {
        ...
        /*US1958804*/
       // else if(event.getParam("clickedTopic") == 'View Payments'){
      //      component.set("v.ViewPayment", true);
        //    var paymentInfo = component.find("paymentInfo");
        //    console.log('payment object retrieved' + paymentInfo)
        //    if (!$A.util.isUndefinedOrNull(paymentInfo)) {
          //      setTimeout(function () {
          //          console.log("inside timeout function");
          //          console.log("paymentinfo get element blog"+paymentInfo.getElement());
          //          paymentInfo.getElement().scrollIntoView({
          //              behavior: "smooth",
          //              block: "start"
         //           });
        //        }, 100);
