({
    ...
    getSelectedMsg : function(component, event, helper) {
    ...
    //SNI_FL_ClearSelectedMessageEvent will fire from SNI_FL_FamilyMessagingHeader 
    //when back button clicked in mobile, then selected message is clear from list
    //Author:Sameera ACDC
