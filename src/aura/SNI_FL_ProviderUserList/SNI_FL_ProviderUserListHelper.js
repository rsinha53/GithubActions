({
    getData : function(component){
        ...
        var action = component.get("c.getProviderUserList");
            ...
            if(state == "SUCCESS"){
                ...
                if(accountWrapper.success){
                    ...
                    accountList.forEach(function(account){
                        if(JSON.stringify(account.FirstName) !=undefined){
                          account.accountName = '/'+account.Id;  
                        }
                        if(JSON.stringify(account.LastName) !=undefined){
                          account.accountName1 = '/'+account.Id;  
                        }
                    });
